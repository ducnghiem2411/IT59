...
import { Box, Button, ButtonBase, Grid, Pagination, Stack, styled, Table, TableBody, TableCell, TableHead, TableRow, useTheme } from '@mui/material'
...
const CustomTable: FC<CustomTableProps> = (props) => {
  ...
  const { getTableProps, getTableBodyProps, headerGroups, prepareRow, page, pageOptions, gotoPage }: any = useTable(
    {
      columns,
      data: tableData,
    },
